...
switch ($user["action"]) {
    ...
    case "download":
        ...
        break;
    case "contact":
        send_mail_text("echorbitaudio@gmail.com", "New Contact Message: " . $user["subject"], "Name: " . $user["name"] . "<br />Email: " . $user["email"] . "<br />Company: " . $user["company"] . "<br />Subject: " . $user["subject"] . "<br />Message: " . $user["message"]);
        $user = ["status" => "success"];
        break;
}
