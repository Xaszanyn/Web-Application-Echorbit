...
switch ($user["action"]) {
    ...
    case "download":
        ...
        break;
    case "contact":
        send_mail_text("contact@echorbitaudio.com", "New Contact Message: " . $user["subject"], "Name: " . $user["name"] . "<br />Email: " . $user["email"] . "<br />Phone: " . $user["phone"] . "<br />Subject" . $user["subject"] . "<br />Message: " . $user["message"]);
        $user = ["status" => "success"];
        break;
}
